...
raw sources. Toolkit contract: `.agentic-cms/bin/README.md`.
...
1. **Candidate set** — run both, union the results:
   ...
   .agentic-cms/bin/ac-search <term1> <term2> <synonyms> <abbreviations>
   ```
...
3. **Recent material**: `.agentic-cms/bin/ac-log tail 10` — flag anything recently
...
```sh
.agentic-cms/bin/ac-page new concept wiki/concepts/<slug>.md --title "<Title>"
# write the synthesis into the page, list refs: of every page used
.agentic-cms/bin/ac-index add concepts wiki/concepts/<slug>.md "<one-line summary>"
.agentic-cms/bin/ac-log append query "<question>" "filed wiki/concepts/<slug>.md"
