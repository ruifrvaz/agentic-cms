...
| 004 | Archive content lifecycle | Not Started | `status: archived` + `docs/<topic>/archive/` mirroring 002's drafts; `ac-page archive`, index re-filed under archived section; start after 002 merges |
